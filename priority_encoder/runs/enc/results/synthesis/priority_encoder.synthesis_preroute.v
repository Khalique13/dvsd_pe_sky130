module priority_encoder (VGND,
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_10 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_43 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_4 FILLER_0_6 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_30 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__buf_1 _11_ (.A(net1),
    .X(_00_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _12_ (.A(net8),
    .Y(_01_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _15_ (.A1(net3),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__o21a_1 _16_ (.A1(_02_),
    .A2(_04_),
    .B1(net7),
    .X(_05_),
    .VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__o32a_1 _17_ (.A1(_00_),
    .A2(_01_),
    .A3(_05_),
    .B1(net1),
    .B2(net9),
 ...
 sky130_fd_sc_hd__inv_2 _18_ (.A(net7),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a211o_1 _19_ (.A1(net4),
    .A2(net5),
    .B1(_02_),
    .C1(_06_),
    .X(_07_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a31o_1 _20_ (.A1(net8),
    .A2(net9),
    .A3(_07_),
    .B1(_00_),
    .X(net13),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__a41o_1 _21_ (.A1(net8),
    .A2(net9),
    .A3(net6),
    .A4(net7),
    .B1(_00_),
 ...
 sky130_fd_sc_hd__or2_1 _22_ (.A(net3),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__or4_1 _23_ (.A(net5),
    .B(net7),
    .C(net9),
    .D(net2),
    .X(_09_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__or4_1 _24_ (.A(net6),
    .B(net8),
    .C(_08_),
    .D(_09_),
    .X(_10_),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__nand2b_1 _25_ (.A_N(_00_),
    .B(_10_),
    .Y(net10),
    .VGND(VGND),
    .VNB(VGND),
